...
class EventController extends ControllerBase{
  ...
  public function editAction(){
    ...
    $this->response->redirect('event'); //ไปยังหน้า event/
    // $this->flashSession->success('อัพเดทข้อมูลเรียบร้อยแล้ว'); //textbox pop-up
    }
  }
  ...
  public function addAction(){
    ...
    $this->response->redirect('event'); //ไปยังหน้า event/
    // $this->flashSession->success('เพิ่มข้อมูลเรียบร้อยแล้ว'); //textbox pop-up
    }
  }
